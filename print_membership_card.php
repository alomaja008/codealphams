...
<head>
    ...
    <style>
        ...
        .card {
            background: rgba(22, 19, 22, 1);
            background: linear-gradient(36deg, rgba(133, 122, 136, 1) 0%, rgba(234, 220, 236, 1) 36%, rgba(201, 171, 206, 1) 64%, rgba(202, 187, 205, 1) 100%);
            border-radius: 10px;
            margin: auto;
            width: 505px;
            height: 320px;
        ...
        .hologram {
            ...
            width: 6.2rem; /* Adjust the width as needed */
